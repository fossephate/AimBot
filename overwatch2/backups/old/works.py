...
while (1):
        ...
        #frame = imutils.resize(frame, width=int(bufferX/4))
        #frame = imutils.resize(frame, width=int(0.6*bufferX))
        ...
        if(center != None):
                ...
                if(abs(xDistance) > 100):
                        xSpdMod = 0.6
                elif(abs(xDistance) <= 100):
                        xSpdMod = 0.3
                elif(abs(xDistance) <= 20):
                        xSpdMod = 0.1
